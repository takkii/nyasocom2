...
Book.create(:isbn=>'9784798053639',:title=>'Pythonプログラミング逆引き大全',:price=>'2600',:publish=>'金城俊哉',:published=>'2018/04/01',:cd=>'true', :status=>'0')
Book.create(:isbn=>'9784863541122',:title=>'Java逆引きハンドブック',:price=>'4000',:publish=>'株式会社エイベル',:published=>'2012/10/27',:cd=>'true', :status=>'0')
Book.create(:isbn=>'9784863540224',:title=>'Ruby逆引きハンドブック',:price=>'3800',:publish=>'るびきち',:published=>'2009/05/25',:cd=>'true', :status=>'0')
Book.create(:isbn=>'9784863542440',:title=>'改訂2版 Ruby逆引きハンドブック',:price=>'3820',:publish=>'卜部昌平',:published=>'2018/08/28',:cd=>'true', :status=>'0')
Book.create(:isbn=>'9784797363821',:title=>'Rails3レシピブック 190の技',:price=>'2980',:publish=>'高橋征義',:published=>'2011/07/25',:cd=>'true', :status=>'0')
Book.create(:isbn=>'9784774149806',:title=>'Ruby on Rails 3 ポケットリファレンス',:price=>'2780',:publish=>'山田祥寛',:published=>'2012/01/26',:cd=>'true', :status=>'0')
Book.create(:isbn=>'9784862671264',:title=>'jpmobileによるモバイルサイト構築',:price=>'2376',:publish=>'小川 伸一郎',:published=>'2012/02/21',:cd=>'true', :status=>'0')
Book.create(:isbn=>'9784844333753',:title=>'Ruby on Rails環境構築ガイド',:price=>'3024',:publish=>'黒田努',:published=>'2013/3/22',:cd=>'true', :status=>'0')
Book.create(:isbn=>'9784774165165',:title=>'パーフェクト Ruby on Rails',:price=>'3110',:publish=>'すがわらまさのり',:published=>'2014/06/06',:cd=>'true', :status=>'0')
Book.create(:isbn=>'9784798121932',:title=>'The RSpec Book',:price=>'4536',:publish=>'David Chelimsky',:published=>'2012/02/22',:cd=>'true', :status=>'0')
Book.create(:isbn=>'9784274066092',:title=>'dRubyによる分散・Webプログラミング',:price=>'3456',:publish=>'関将俊',:published=>'2005/7/1',:cd=>'true', :status=>'0')
Book.create(:isbn=>'9784774183619',:title=>'オブジェクト指向設計実践ガイド',:price=>'3542',:publish=>'髙山泰基',:published=>'2016/09/02',:cd=>'true', :status=>'0')
Book.create(:isbn=>'9784873111308',:title=>'詳説 正規表現 第2版 ',:price=>'2587',:publish=>'田和 勝',:published=>'2003/5/26',:cd=>'true', :status=>'0')
Book.create(:isbn=>'9784894714809',:title=>'プログラマのためのSQL 第2版',:price=>'4500',:publish=>'ジョー セルコ',:published=>'2001/04/01',:cd=>'true', :status=>'0')
Book.create(:isbn=>'9784798122335',:title=>'Hadoop徹底入門',:price=>'3800',:publish=>'太田 一樹',:published=>'2011/01/28',:cd=>'true', :status=>'0')
Book.create(:isbn=>'9784894717152',:title=>'Java言語仕様 第3版',:price=>'5700',:publish=>'ビル ジョイ',:published=>'2006/12/01',:cd=>'true', :status=>'0')
Book.create(:isbn=>'9784501552602',:title=>'プログラミング言語 Java 第4版',:price=>'4212',:publish=>'ジェームズ ゴスリン',:published=>'2014/05/10',:cd=>'true', :status=>'0')
Book.create(:isbn=>'9784777512126',:title=>'Javaゲーム制作教科書',:price=>'2300',:publish=>'片山幸雄',:published=>'2006/04/01',:cd=>'true', :status=>'0')
Book.create(:isbn=>'9784621066058',:title=>'EFFECTIVE JAVA 第2版',:price=>'3888',:publish=>'柴田芳樹',:published=>'2014/03/11',:cd=>'true', :status=>'0')
Book.create(:isbn=>'9784798124605',:title=>'Beginning Java EE 6',:price=>'4536',:publish=>'Antonio Goncalves',:published=>'2012/03/09',:cd=>'true', :status=>'0')
Book.create(:isbn=>'9784844335344',:title=>'Effective Android',:price=>'3200',:publish=>'TechBooster',:published=>'2014/01/17',:cd=>'true', :status=>'0')
Book.create(:isbn=>'9784048703673',:title=>'サーバサイドJavaScript',:price=>'3800',:publish=>'清水俊博',:published=>'2014/02/27',:cd=>'true', :status=>'0')
Book.create(:isbn=>'9784621303252',:title=>'Effective Java 第3版',:price=>'4320',:publish=>'柴田茂樹 訳',:published=>'2018/10/30',:cd=>'true', :status=>'0')
Book.create(:isbn=>'9784295003038',:title=>'GitLab実践ガイド',:price=>'2700',:publish=>'北山晋吾',:published=>'2018/02/01',:cd=>'true', :status=>'0')
Book.create(:isbn=>'9784844331568',:title=>'改訂新版 基礎Ruby on Rails',:price=>'3200',:publish=>'黒田努',:published=>'2012/03/05',:cd=>'true', :status=>'0')
Book.create(:isbn=>'9784295004608',:title=>'改訂4版 基礎 Ruby on Rails',:price=>'3780',:publish=>'黒田努',:published=>'2018/09/07',:cd=>'true', :status=>'0')
Book.create(:isbn=>'9784844335924',:title=>'実践Ruby on Rails 4',:price=>'3780',:publish=>'黒田努',:published=>'2014/05/23',:cd=>'true', :status=>'0')

#Book.create(:isbn=>'',:title=>'',:price=>'',:publish=>'',:published=>'',:cd=>'true', :status=>'0')
